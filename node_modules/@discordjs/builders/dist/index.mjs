...
var stringPredicate = s8.string.lengthGreaterThanOrEqual(1).lengthLessThanOrEqual(100);
var numberPredicate = s8.number.greaterThan(Number.NEGATIVE_INFINITY).lessThan(Number.POSITIVE_INFINITY);
var choicesPredicate = s8.object({
  name: stringPredicate,
  name_localizations: localizationMapPredicate,
  value: s8.union(stringPredicate, numberPredicate)
}).array;
...
// src/interactions/slashCommands/options/integer.ts
var numberValidator = s9.number.int;
...
var numberValidator2 = s10.number;
...
var minLengthValidator2 = s11.number.greaterThanOrEqual(0).lessThanOrEqual(6e3);
var maxLengthValidator2 = s11.number.greaterThanOrEqual(1).lessThanOrEqual(6e3);
...
SlashCommandBuilder = __decorateClass([
  mix6(SharedSlashCommandOptions, SharedNameAndDescription, SharedSlashCommandSubcommands)
], SlashCommandBuilder);
...
var namePredicate2 = s12.string.lengthGreaterThanOrEqual(1).lengthLessThanOrEqual(32).regex(/^( *[\p{P}\p{L}\p{N}\p{sc=Devanagari}\p{sc=Thai}]+ *)+$/u).setValidationEnabled(isValidationEnabled);
var typePredicate = s12.union(s12.literal(ApplicationCommandType.User), s12.literal(ApplicationCommandType.Message)).setValidationEnabled(isValidationEnabled);
var booleanPredicate3 = s12.boolean;
...
var dmPermissionPredicate2 = s12.boolean.nullish;
function validateDMPermission2(value) {
  dmPermissionPredicate2.parse(value);
}
__name(validateDMPermission2, "validateDMPermission");
var memberPermissionPredicate2 = s12.union(
  s12.bigint.transform((value) => value.toString()),
  s12.number.safeInt.transform((value) => value.toString()),
  s12.string.regex(/^\d+$/)
).nullish;
